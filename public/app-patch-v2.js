        ...
        function _renderPostActions(area, postEl) {
            ...
            likeBtn.addEventListener('click', function () {
                ...
                if (postId && typeof window.toggleLike === 'function') window.toggleLike(postId);
                    ...
                    try {
                        var ref = window.fbDb.collection('posts').doc(postId);
            ...
            rtBtn.addEventListener('click', function () {
                ...
                if (postId && _fbOk()) {
                    try { window.fbDb.collection('posts').doc(postId).update({ retweetCount: rtCount }); } catch (e) {}
                }
            });
            ...
            panel.querySelectorAll('.vf-panel-msg-btn').forEach(function (mb) {
                ...
                mb.addEventListener('click', function (e) {
                    ...
                    if (typeof window.openChatWith === 'function')        window.openChatWith(sid, sname, '');
                        ...
                        _notify('Find ' + sname + ' in Messages to chat.', 'info');
                    }
                });
            });
        }
