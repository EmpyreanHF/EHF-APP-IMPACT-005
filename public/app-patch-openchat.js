...
(function empyreanOpenChat() {
    ...
    function _showEmojiBar(row, msgId, x, y) {
        ...
        setTimeout(function() {
            document.addEventListener('click', function _closeBar(e) {
                ...
                _hideEmojiBar();
                document.removeEventListener('click', _closeBar, true);
            }, { capture: true });
        }, 400);
    }
    ...
    function _buildChatView(peerId, peerName, peerAvatar) {
        ...
        function _doCloseChat(ev, _viaPopstate) {
            ...
            if (_cv) {
                ...
                /* Move back to original parent (reverses the body-append we did on open) */
                if (_cv._ocOrigParent && _cv._ocOrigParent !== document.body) {
                    try {
                        _cv._ocOrigParent.insertBefore(_cv, _cv._ocOrigNextSibling || null);
                    } catch(err) {
                        /* parent may have been removed — just leave it on body */
                    }
                }
            }
